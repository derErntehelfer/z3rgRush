...
class payloadFactory:
    ...
    def iteratePayloads(self, target, wordlistPath, filetypes=None):
    ...
    def generatePayloads(self, target, wordlistPath, filetypeArg=None):
        filetypes = self.loadFiletypes(filetypeArg)
        return list(self.iteratePayloads(target, wordlistPath, filetypes))
